    ...
    public class AuthorsController : ControllerBase
    {
            ...
            [FromQuery] AuthorsResourceParameters authorsResourceParameters)
        {
            ...
            Response.Headers.Add("X-Pagination",
                JsonSerializer.Serialize(pagiantionMetadata)); // AGREGAMOS LOS DATOS DE LA PAGINACION EN LA CABECERA
            ...
            [FromHeader(Name = "Accept")] string mediaType)
        {
            ...
            var includesLinks = parsedMediaType.SubTypeWithoutSuffix
            ...
            var primaryMediaType = includesLinks ?
